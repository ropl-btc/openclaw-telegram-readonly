...
def cmd_help(args: argparse.Namespace) -> int:
    payload = {
        ...
        "examples": [
            "telegram_readonly.py dialogs --query 'petros skynet'",
            "telegram_readonly.py messages --chat @suuuupaman --limit 20 --reverse",
            "telegram_readonly.py search 'btc_txid_here' --limit 20",
            "telegram_readonly.py unread-dialogs --limit 10",
            "telegram_readonly.py unread-dms --limit 10 --include-muted",
        ],
    }
